...
func TestCallLedgerActualCostUnknownForMissingCachePricesOrOverflow(t *testing.T) {
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			sequence := ledger.Begin(CallTicket{Kind: CallAnswer, EstimatedMicroUSD: 17}, 0)
...
func TestCallLedgerAggregateDistinguishesKnownAndUnknownActualCost(t *testing.T) {
	...
	first := ledger.Begin(CallTicket{Kind: CallAnalyzer, EstimatedMicroUSD: 3}, 0)
	second := ledger.Begin(CallTicket{Kind: CallAnswer, EstimatedMicroUSD: 7}, 0)
...
func TestCallLedgerAggregateMarksOverflowedActualCostUnknown(t *testing.T) {
	...
	first := ledger.Begin(CallTicket{Kind: CallAnswer}, 0)
	second := ledger.Begin(CallTicket{Kind: CallAnswer}, 0)
